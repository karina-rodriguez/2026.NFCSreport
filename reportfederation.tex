...
This report aims to reflect the collective voice of the Arts \& Humanities (A\&H) research communities advocating for access to Digital Research
 ...
 Within these communities, researchers are increasingly using data science and digital methods in their research, as well as producing data and software outputs. The resulting datasets are often well curated in accordance with the FAIR (findable, accessible, interoperable, reusable) principles to enable structuring and connecting knowledge. They can enable data analytics approaches that provide further insights and drive innovation. To streamline and enhance the retention, use/reuse and preservation of these outputs, iDAH gives researchers dedicated data services which cater for different disciplines
