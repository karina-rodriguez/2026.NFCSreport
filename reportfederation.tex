...
\subtitle{\LARGE{Insights into Digital Research Practices and Infrastructures}}
\date{\normalsize{January 2026}}
\author[1]{Karina Rodriguez Echavarria}
\author[1]{Myrsini Samaroudi}
\author[2]{Arianna Cuila}
...
This report aims to reflect the collective voice of the Arts \& Humanities (A\&H) research communities advocating for access to Digital Research
 Infrastructure (DRI) in ways which work to support their digital research workflows and data management practices. 
 The (A\&H) communities brings together researchers across three
 ...
 3) Languages and Literature (AHRC, 2025). The research in these areas is
...
Within these community, researchers often use and/or produce datasets as outputs of A\&H research projects. These constitute carefully curated datasets which
value resides in their curation according to the FAIR (findable, accessible,
interoperable, reusable) principles to enable structuring and connecting
knowledge, alongside large-scale datasets whose value lies in allowing data
analytic approaches and supporting research methods to provide further
knowledge insights and drive innovation. To streamline and enhance the
retention, use/reuse and preservation of those “valuable” datasets, iDAH gives
researchers dedicated data services which cater for different disciplines
and/or types of data. These include the Distributed System of Scientific
...
Skills in Arts and Humanities (DISKAH) Network}, the \href{https://www.ccpahc.ac.uk/}{Collaborative Computational
Project for Arts Humanities and Culture (CCP-AHC)} and \href{https://www.turing.ac.uk/research/research-projects/dataculture-building-sustainable-communities-around-arts-and-humanities}{DataCulture}.  
...
\subsection{Research Outputs, Datasets and Software Outputs}  
\textbf{Communities use and produce heterogeneous datasets of varying complexities involving multiple formats, parts, sizes and data types. While textual data has the strongest representation, a large percentage of researchers work with multidimensional data, including born digital data (e.g. spatial, numerical, visual, audiovisual) and sensor data (real-time). Researchers also generate a range of software artefacts, particularly interactive applications, mobile apps, and server-side applications.}
...
\item DRI should support moving data via batch file transfers, and orchestration across systems can be supported by long-lived or refreshable access tokens 
(\cite[5]{collier25}).  

\item DRI should support a minimum level of centralisation and integration to store, analyse, and share data, while exploring the potential of decentralisation technologies (\cite[1,12]{hawkins_2024_14006955}).  
\end{enumerate} 
...
\item DRI should establish a minimum requirement for data integrity and standardisation through ontologies, taxonomies and vocabularies should be agreed for indexing, naming, and cataloguing. Workflows with Machine learning methods should be explored (\cite[53]{de_roure_2022_4716148}; \cite[14]{hawkins_2024_14006955}). 
\end{enumerate}
...
\noindent\textbf{Communities have a major concern for the security of the data given the recognised value of the curated data.} 
...
(De Roure et al., 2022; Jackson et al., 2023, p. 5). Trusted environments should be available for data, which is sensitive in nature, including historically and commercially sensitive as well as stray data. These TREs should have policies tailored to sensitive content rather than the focus on personal data to minimise excessive barriers to research 
...
\noindent\textbf{Communities consider of value reproducible workflows for data science approaches.}
...
\item DRI should provide supported tools and environments for research workflows and pipelines of connected processes and algorithms using virtualisation tools such as virtual machines, Docker and Singularity containers and Kubernetes virtual clusters 
...
\noindent\textbf{Communities predominantly relies on graphical and visually rich interfaces for workflows and interfaces, with limited familiarity with command-line tools and programming languages.}
...
The process should include matchmaking datasets with a suitable repository and guiding users through various computing techniques for data cleaning, text/data mining, data visualisation, immersive technologies, database design, statistics, machine learning, geospatial data, NLP, topic modelling, computer vision, and probalistic thinking 
...
\subsection{Communities of Practice and Professional Development}
...
\item DRI should be supported by networking, approaches for collaborating and skills, formal and informal training, internships, and placements to support people at various career stages and in different organisations 
